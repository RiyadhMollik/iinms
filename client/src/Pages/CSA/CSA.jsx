  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen w-[159vh]">
      <div className="flex justify-between">
        <h1 className="text-3xl font-bold mb-6 text-center text-black">CSA List</h1>
        <button
      ...
      {modalVisible && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-white rounded-lg shadow-lg w-1/3 p-6 relative">
            <h2 className="text-2xl font-bold mb-4 text-center">{isEditMode ? "Edit CSA" : "Add CSA"}</h2>
            <label className="block mb-2 font-medium">CSA Name</label>
            <input
              type="text"
              value={currentRole}
