...
import { FaTachometerAlt, FaCloudSun, FaWater, FaSignOutAlt, FaClipboardList, FaCogs, FaArchive, FaComments, FaInfoCircle, FaPumpSoap, FaSeedling, FaCloud, FaLeaf, FaTint, FaGasPump, FaUsers, FaChartBar, FaUserFriends } from "react-icons/fa";
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col px-4 space-y-4 mt-4">
        ...
        <div>
          <Link to="/user-report">
            <button className={`flex items-center w-full px-4 py-2 rounded-lg ${isActive("/user-report") ? "bg-green-700 text-white" : "bg-gray-100 hover:bg-green-700 hover:text-white"}`}>
              <FaUserFriends className="mr-3" /> User Report
            </button>
          </Link>
        </div>
